# OpenAPITest OpenAPI Specification
[![Build Status](https://travis-ci.org/christianbriggs/openapi-test.svg?branch=master)](https://travis-ci.org/christianbriggs/openapi-test)
...
6. If you did everything correct, https://christianbriggs.github.io/openapi-test/ will lead to your new docs
...
- Documentation(ReDoc): https://christianbriggs.github.io/openapi-test/
- SwaggerUI: https://christianbriggs.github.io/openapi-test/swagger-ui/
- Look full spec:
    + JSON https://christianbriggs.github.io/openapi-test/swagger.json
    + YAML https://christianbriggs.github.io/openapi-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://christianbriggs.github.io/openapi-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://christianbriggs.github.io/openapi-test/ with url from the message: `Server started <url>`
